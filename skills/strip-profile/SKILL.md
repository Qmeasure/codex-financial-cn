...
- **市场数据**：Bloomberg、FactSet、CapIQ（12-24 个月原始股价、最新价格、52 周区间、股本、市值、净债务、EV、股权结构）；A股/港股可使用已授权 MCP 或官方/交易所数据
...
| **4** | x=5.0, y=3.7, w=4.7, h=3.5 | **上市公司**：12-24 个月原始股价图 + 前几大股东；股价图不做归一化，并标注最新价格、52 周区间、数据日期和来源。**非上市公司**：近期进展或股权/M&A 历史 |
...
| 产品组合 | 带百分比的饼图 |
| 财务对比 | 柱状图 |
| 股价（12-24 个月日频） | 折线图，不做归一化，标注最新价格、52 周区间、数据日期和来源 |
...
- [ ] 标题区包含公司名称、ticker、行业
- [ ] 标题下方正好 4 个等大象限
- [ ] 上市公司首页股价/近期进展象限包含 12-24 个月原始股价图，不做归一化
